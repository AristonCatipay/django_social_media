...
urlpatterns = [
    ...
    path('region/update/<int:region_primary_key>/', views.update_region, name='update_region'),
    ...
    path('province/update/<int:province_primary_key>/', views.update_province, name='update_province'),
    ...
    path('city/update/<int:city_municipality_primary_key>/', views.update_city_municipality, name='update_city_municipality'),
    ...
    path('barangay/update/<int:barangay_primary_key>/', views.update_barangay, name='update_barangay'),
